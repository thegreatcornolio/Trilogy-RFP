...
def build():
    ...
    add_para(
        doc,
        "A2.3  The expiration or termination of this Agreement shall not affect those provisions which expressly or by necessity survive, including confidentiality, liability, IP, accrued Charges, commission on revenues billed in respect of introductions made during the Term, and dispute resolution.",
        align="justify",
    )
    ...
    add_para(
        doc,
        "Both parties will keep all Confidential Information received from the other party confidential and secure. The receiving party must return or destroy such information upon termination or upon request, save for information it is required to retain for legal reasons. A receiving party may disclose such information strictly to its employees, representatives, professional advisors and direct suppliers (including Precision Point, in the case of the Supplier) who are required to know it for this Agreement, provided that such person is subject to confidentiality undertakings, or if required to be disclosed by law. If required to be disclosed by law, the receiving party shall notify the disclosing party as soon as possible prior to disclosure, if it is legally possible and/or able.",
        align="justify",
    )

    heading(doc, "A7.  Liability", 2)
    add_para(
        doc,
        "A7.1  The Supplier shall only be liable for its own actions or omissions and shall not be liable for: any act or omissions of any third party (other than its subcontractors in respect of the Services); unavailability of systems due to disruption of or any failure or fault in apparatus, lines and systems (including a failure in any third party’s network); suspension of Services for routine or emergency maintenance or for non-payment; any event or circumstance which is out of the reasonable control of the Supplier (a force majeure event); any failure of non-Supplier equipment; any breach of security which occurs notwithstanding the Supplier’s compliance with its security undertakings.",
        align="justify",
    )
    add_para(
        doc,
        "A7.2  The Supplier’s liability, howsoever arising, is limited to the value of the professional fees that the Client has paid under the Addendum which is the subject of a claim in the immediate prior 12 months. Neither party is liable for indirect, incidental, or consequential damages, including loss of profit, revenue, goodwill or anticipated savings.",
        align="justify",
    )
    add_para(
        doc,
        "A7.3  Nothing in this Agreement excludes liability for fraud, death or personal injury caused by negligence, or any liability that cannot be excluded by South African law.",
        align="justify",
    )

    heading(doc, "A8.  Intellectual property", 2)
    add_para(
        doc,
        "Each party retains ownership of its intellectual property, with no transfer of rights unless expressly agreed in writing. The Client is granted a non-exclusive licence to use deliverables produced under an Addendum for its internal business purposes. The Supplier may reuse generic know-how, methodologies and templates. Marketing and sales collateral produced for the Client may be used by both parties for the purpose of the engagement.",
        align="justify",
    )

    heading(doc, "A9.  Force majeure", 2)
    add_para(
        doc,
    ...
    heading(doc, "A10.  Dispute resolution", 2)
    add_para(
        doc,
        "A10.1  In the event of a dispute arising from or in connection with this Agreement, the parties shall first attempt to resolve the matter through good faith negotiations.",
        align="justify",
    )
    add_para(
        doc,
        "A10.2  If unresolved within 10 business days, the dispute shall be referred to mediation, and if necessary, arbitration in Johannesburg in accordance with the rules of the Arbitration Foundation of Southern Africa (AFSA). This clause shall not preclude either party from seeking urgent interim relief, and the Supplier shall be entitled to approach any court of competent jurisdiction for any unpaid Charges.",
        align="justify",
    )

    heading(doc, "A11.  General", 2)
    generals = [
        "A11.1  This Agreement will be governed under the laws of South Africa, and both parties submit to the exclusive jurisdiction of the South African courts (subject to clause A10).",
        "A11.2  This Agreement is the whole agreement between the Client and the Supplier and excludes any express or implied or tacit term, representation, warranty, promise or the like not recorded herein, whether it induced the contract or not, save for any statutory requirements. Any variation to this Agreement must be in writing and signed between the parties.",
        "A11.3  A failure or delay by a party to exercise any right or remedy hereunder or by law shall not constitute a waiver of that or any other right or remedy.",
        "A11.4  All notices must be delivered by hand or email to the address on the cover pages, or any other address notified to the other party, which takes effect on the 5th day of written notification. Any notice given in writing and actually received by a party’s authorised representatives will be deemed properly given, notwithstanding that it has not been given in accordance with this clause.",
        "A11.5  When any number of days is prescribed, same shall be reckoned exclusively of the first and inclusively of the last day unless the last day falls on a Saturday, Sunday or South African public holiday, in which case the last day shall be the next succeeding business day.",
        "A11.6  It is specifically recorded that whilst the parties may correspond via e-mail for operational reasons, no formal legal notice nor any amendment to the Agreement will be of any force and effect if communicated via e-mail, unless specifically for purposes of attaching a signed notice, save that (i) invoices and purchase-order references may be sent by e-mail, and (ii) prior agreement to pass-through costs may be given by e-mail.",
        "A11.7  The provisions of the Agreement are severable and the invalidity of any one or more of such provisions will in no way affect the validity of the remaining provisions.",
        "A11.8  Neither party may assign or transfer (in whole or in part) any of its rights or obligations under the Agreement, without the other party’s prior written consent (such consent not to be unreasonably withheld or delayed), except that the Supplier may assign to an affiliate in the Trilogy group on written notice.",
        "A11.9  The Agreement may be executed in any number of counterparts, including electronic signature contemplated in the Electronic Communications and Transactions Act, 25 of 2002. No counterpart shall be effective until each party has executed at least one counterpart.",
        "A11.10  The provisions of this Agreement shall be binding upon the successors-in-title and assigns of the parties.",
        "A11.11  The rule of interpretation that a contract is to be interpreted against the party responsible for drafting shall not apply.",
        "A11.12  \"Calendar month\" means a month beginning on the first day of any given month and ending on the last day of the same month. Where notice is given on any day of the month other than the first, the notice period will only commence on the first day of the following month.",
    ]
    for g in generals:
    ...
    heading(doc, "1.9  Client dependencies", 2)
    ...
    heading(doc, "1.10  Acknowledgement of this Addendum", 2)
    add_para(
        doc,
